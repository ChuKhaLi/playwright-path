...
import { test, expect, BrowserContext, devices } from '@playwright/test';
...
export class ContextProfiles {
   ...
   */
  static async createGuestContext(browser: any): Promise<BrowserContext> {
    return await browser.newContext({
   ...
   */
  static async createAPITestContext(browser: any): Promise<BrowserContext> {
    return await browser.newContext({
      extraHTTPHeaders: {
        'X-Test-Type': 'api',
        'X-API-Version': 'v1',
...
export class DeviceProfiles {
   ...
   */
  static async createMobileContext(browser: any, options: {
    device?: string;
   ...
   */
  static async createTabletContext(browser: any, options: {
    orientation?: 'portrait' | 'landscape';
  } = {}): Promise<BrowserContext> {
   ...
   */
  static async createDesktopContext(browser: any, options: {
...
export class NetworkSimulation {
   ...
   */
  static async apply3GConditions(page: any): Promise<void> {
   ...
   */
  static async apply4GConditions(page: any): Promise<void> {
    await page.route('**/*', async (route: any) => {
   ...
   */
  static async applySlowConnection(page: any): Promise<void> {
    await page.route('**/*', async (route: any) => {
...
export class SecurityContexts {
   ...
   */
  static async createMediaPermissionsContext(browser: any): Promise<BrowserContext> {
    return await browser.newContext({
   ...
   */
  static async createLocationContext(browser: any, location: {
    latitude: number;
    longitude: number;
  }): Promise<BrowserContext> {
    return await browser.newContext({
   ...
   */
  static async createNotificationContext(browser: any): Promise<BrowserContext> {
    return await browser.newContext({
      permissions: ['notifications'],
      extraHTTPHeaders: {
   ...
   */
  static async createRestrictedContext(browser: any): Promise<BrowserContext> {
    return await browser.newContext({
